...
def add_arguments(parser):
    ...
    parser.add_argument("--out_dir", type=str, default='/home/will/nmt_attention_model',
    ...
    parser.add_argument("--inference_output_file", type=str, default='/home/will/Documents/nmt_attention_model/output_infer',
...
def run_main(flags, default_hparams, train_fn, inference_fn, target_session="", input_sentence=""):
    """Run main."""
    # Job
    jobid = flags.jobid
    ...
    ## Train / Decode
    if flags.inference_input_file or input_sentence:
        ...
        translation = inference_fn(ckpt, flags.inference_input_file or input_sentence,
...
def main(input_sentence):
    ...
    output_sentence = run_main(FLAGS, default_hparams, train_fn, inference_fn, input_sentence=input_sentence[0])
...
def parse(input_sentence):
    ...
    print(FLAGS)
    print(unparsed)
    tf.app.run(main=main, argv=[input_sentence])


if __name__ == "__main__":
    # parse('They wrote almost a thousand pages on the topic .')
    parse("嗨 ， 很 高兴 见到 你 .")
